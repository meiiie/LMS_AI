...
See ``maritime-ai-service/docs/architecture/SYSTEM_ARCHITECTURE.md`` for the
current runtime boundary. Migration checkpoints remain available in Git history.
"""
